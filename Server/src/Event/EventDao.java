...
public class EventDao {
    ...
    public List<Event> findByDateAndType(LocalDate date, EventManager.EventTypes type) {
        return em.createQuery("select event from Event event " +
    ...
    public List<Event> findByDateAndTypeAndCity(LocalDate date, EventManager.EventTypes type, String city) {
        return em.createQuery("select event from Event event " +
                "where :date between event.startDate and event.finishDate " +
                "and event.eventType = :type " +
                "and event.area = :city")
